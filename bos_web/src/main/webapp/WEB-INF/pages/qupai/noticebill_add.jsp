			...
			<table class="table-edit" width="99%" align="center">
				...
				<tr>
					...
					<td><input type="text" class="easyui-validatebox"
						name="telephone" required="true" id="telephoneInput" /> <script
									...
									.blur(
											function name() {
												var telephone = this.value;
														$.post(
																"${pageContext.request.contextPath}/noticebillAction_findCustomerByTelephone",
																{
																	telephone : telephone
																}, function(data) {
					...
					<td>客户编号:</td>
					<td><input type="text" class="easyui-validatebox"
						name="customerId" required="true" /></td>
				</tr>
				<tr>
					<td>客户姓名:</td>
					<td><input type="text" class="easyui-validatebox"
						name="customerName" required="true" /></td>
					<td>联系人:</td>
					<td><input type="text" class="easyui-validatebox"
						name="delegater" required="true" /></td>
				</tr>
				<tr class="title">
